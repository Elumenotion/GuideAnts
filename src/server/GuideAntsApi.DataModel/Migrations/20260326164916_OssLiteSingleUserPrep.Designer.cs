...
namespace GuideAntsApi.DataModel.Migrations
{
    ...
    [Migration("20260326164916_OssLiteSingleUserPrep")]
    partial class OssLiteSingleUserPrep
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GuideAntsApi.DataModel.Models.AccessCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("GuideAntsApi.DataModel.Models.AccessCodeCampaign", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GuideAntsApi.DataModel.Models.Assistant", b =>
                {
                    ...
                    b.HasIndex("OwnerTeamId", "Kind");

                    b.HasIndex("OwnerTeamId", "Name")
                        .IsUnique()
                        .HasFilter("[OwnerTeamId] IS NOT NULL");

                    b.HasIndex("OwnerUserId", "Name")
                        .IsUnique()
                        .HasDatabaseName("IX_Assistants_OwnerUserId_Name")
            ...
            modelBuilder.Entity("GuideAntsApi.DataModel.Models.Plan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("BillingIntervalUnit")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("StripePriceFlatId")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<string>("StripePriceMeteredId")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.Property<int>("UsageWindowDays")
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AllowanceAmount = 10.00m,
                            BillingIntervalCount = 1,
                            BillingIntervalUnit = 0,
                            Created = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            CurrencyCode = "USD",
                            IsActive = true,
                            Name = "Free",
                            SubscriptionPrice = 0.00m,
                            UsageWindowDays = 60
                        },
                        new
                        {
                            ...
                            AllowanceAmount = 10.00m,
                            BillingIntervalCount = 1,
                            BillingIntervalUnit = 1,
                            Created = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            CurrencyCode = "USD",
                            IsActive = true,
                            Name = "Monthly Pro",
                            SubscriptionPrice = 10.00m,
                            UsageWindowDays = 30
                        },
                        new
                        {
                            ...
                            AllowanceAmount = 10.00m,
                            BillingIntervalCount = 1,
                            BillingIntervalUnit = 2,
                            Created = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            CurrencyCode = "USD",
                            IsActive = true,
                            Name = "Annual Pro (Save $20)",
                            SubscriptionPrice = 100.00m,
                            UsageWindowDays = 365
                        });
                });
            ...
            modelBuilder.Entity("GuideAntsApi.DataModel.Models.ProjectRole", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GuideAntsApi.DataModel.Models.ProjectUserRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ProjectId", "UserId", "ProjectRoleId")
                        .IsUnique();
            ...
            modelBuilder.Entity("GuideAntsApi.DataModel.Models.Team", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GuideAntsApi.DataModel.Models.TeamCreditTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TeamId", "Created");

                    b.HasIndex("TeamId", "ReferenceId");

                    b.ToTable("TeamCreditTransactions");
                });

            modelBuilder.Entity("GuideAntsApi.DataModel.Models.TeamCreditWallet", b =>
                {
                    b.Property<Guid>("TeamId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("TeamCreditWallets");
                });

            modelBuilder.Entity("GuideAntsApi.DataModel.Models.TeamDailyInvoiceItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TeamId", "UtcDate")
                        .IsUnique();

                    b.ToTable("TeamDailyInvoiceItems");
                });

            modelBuilder.Entity("GuideAntsApi.DataModel.Models.TeamInvitation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("AccessCode")
                        .HasDatabaseName("IX_TeamInvitations_AccessCode");
                    ...
                    b.HasIndex("TeamId", "Email")
                        .IsUnique()
                        .HasDatabaseName("IX_TeamInvitations_PendingUnique_Team")
                        .HasFilter("[Status] = 0 AND [ProjectId] IS NULL");

                    b.HasIndex("TeamId", "ProjectId", "Email")
                        .IsUnique()
                        .HasDatabaseName("IX_TeamInvitations_PendingUnique_Project")
                        .HasFilter("[Status] = 0 AND [ProjectId] IS NOT NULL");

                    b.ToTable("TeamInvitations");
                });

            modelBuilder.Entity("GuideAntsApi.DataModel.Models.TeamMembership", b =>
                {
                    b.Property<Guid>("TeamId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GuideAntsApi.DataModel.Models.TeamPlanSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("StripeItemFlatId")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<string>("StripeItemMeteredId")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.HasIndex("TeamId")
                        .IsUnique()
                        .HasDatabaseName("IX_TeamPlanSubscriptions_ActivePerTeam")
                        .HasFilter("[Status] = 0 AND [EffectiveEnd] IS NULL");

                    b.HasIndex("TeamId", "EffectiveStart");

                    b.ToTable("TeamPlanSubscriptions");
                });

            modelBuilder.Entity("GuideAntsApi.DataModel.Models.TeamRole", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GuideAntsApi.DataModel.Models.Tool", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            DisplayName = "Removed Tool 004",
                            DisplayOrder = 3,
                            IsActive = true,
                            ToolType = "removed_tool_004"
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            Created = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Deprecated tool.",
                            DisplayName = "Removed Tool 006",
                            DisplayOrder = 5,
                            IsActive = true,
                            ToolType = "removed_tool_006"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("GuideAntsApi.DataModel.Models.User", b =>
                {
                    ...
                    b.Property<string>("RedeemedAccessCode")
                        .HasMaxLength(6)
                        .HasColumnType("nvarchar(6)");
                    ...
                    b.HasIndex("RedeemedAccessCode")
                        .HasDatabaseName("IX_Users_RedeemedAccessCode");
            ...
            modelBuilder.Entity("GuideAntsApi.DataModel.Models.AccessCode", b =>
                {
                    b.HasOne("GuideAntsApi.DataModel.Models.AccessCodeCampaign", "Campaign")
            ...
            modelBuilder.Entity("GuideAntsApi.DataModel.Models.Assistant", b =>
                {
                    ...
                    b.HasOne("GuideAntsApi.DataModel.Models.Team", "OwnerTeam")
                        .WithMany("OwnedAssistants")
                        .HasForeignKey("OwnerTeamId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("GuideAntsApi.DataModel.Models.User", "OwnerUser")
                        .WithMany()
            ...
            modelBuilder.Entity("GuideAntsApi.DataModel.Models.ConversationLock", b =>
                {
                    ...
                    b.HasOne("GuideAntsApi.DataModel.Models.User", "LockedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("GuideAntsApi.DataModel.Models.Project", b =>
                {
                    ...
                    b.HasOne("GuideAntsApi.DataModel.Models.Team", "Team")
                        .WithMany("Projects")
            ...
            modelBuilder.Entity("GuideAntsApi.DataModel.Models.ProjectUserRole", b =>
                {
                    ...
                    b.HasOne("GuideAntsApi.DataModel.Models.ProjectRole", "ProjectRole")
                        .WithMany("ProjectUserRoles")
            ...
            modelBuilder.Entity("GuideAntsApi.DataModel.Models.TeamCreditWallet", b =>
                {
                    b.HasOne("GuideAntsApi.DataModel.Models.Team", "Team")
                        ...
                        .HasForeignKey("GuideAntsApi.DataModel.Models.TeamCreditWallet", "TeamId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("GuideAntsApi.DataModel.Models.TeamInvitation", b =>
                {
                    b.HasOne("GuideAntsApi.DataModel.Models.User", "InvitedByUser")
                        .WithMany()
                    ...
                    b.HasOne("GuideAntsApi.DataModel.Models.TeamRole", "TeamRole")
                        .WithMany("TeamInvitations")
            ...
            modelBuilder.Entity("GuideAntsApi.DataModel.Models.TeamPlanSubscription", b =>
                {
                    b.HasOne("GuideAntsApi.DataModel.Models.Plan", "Plan")
