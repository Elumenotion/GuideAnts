...
namespace GuideAntsApi.DataModel.Migrations
{
    ...
    [Migration("20260906000000_RelaxFileLineageNotebookIdConstraint")]
    partial class RelaxFileLineageNotebookIdConstraint
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GuideAntsApi.DataModel.Models.FileLineageEvent", b =>
                {
                    ...
                    b.ToTable("FileLineageEvents", t =>
                        {
                            t.HasCheckConstraint("CK_FileLineageEvent_NotebookId", "FileKind = 0 OR (FileKind = 1 AND NotebookId IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("GuideAntsApi.DataModel.Models.ProjectScheduledJobRun", b =>
                {
                    ...
                    b.HasIndex("ScheduledJobId", "Status");
