import { validateReasoningChoicesJson, validateSamplingParametersJson } from '../../parameterSurface';
    ...
    <div className="space-y-4 rounded border border-gray-200 bg-gray-50 px-3 py-3">
      ...
      <div className="space-y-2">
        ...
        <p className="text-[11px] text-gray-500">
          JSON array of non-empty strings saved to the model row as ReasoningChoicesJson. Leave empty to derive from
          thinking control keys at create time.
        </p>
