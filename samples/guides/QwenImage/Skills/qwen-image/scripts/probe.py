#!/usr/bin/env python3
"""Deployment probe for Qwen Image BF16 skills via Max gateway."""
    ...
    report = {
        ...
        "routes": {
            "route_remote_skill_gateway": {
                ...
                "note": (
                    "PC sandbox → Max /qwen-image-skill with QWEN_IMAGE_SKILL_BASE_URL + "
                    "QWEN_IMAGE_SKILL_TOKEN. If missing, ask the user to set them in the "
                    "guide's Environment variables — do not scan the LAN or guess Max's IP."
                ),
                "evidence": gateway,
            },
        },
