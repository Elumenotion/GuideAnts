        ...
        behaviorContent={(
          <div className="space-y-2 border-t border-gray-100 pt-4">
            ...
            <ul className="list-disc space-y-1 pl-5 text-sm text-gray-700">
              ...
              <li>
                Use <span className="font-mono">SpeechSynthesis:TimeoutSeconds</span> for the local HTTP client. Use the <span className="font-medium">Local TTS model</span> manager above to download the catalog model and select a reference voice in-app.
              </li>
            </ul>
          </div>
        )}
