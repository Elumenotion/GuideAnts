...
export GA_EMB_DEFAULT_MODEL_PATH="${GA_EMB_DEFAULT_MODEL_PATH:-harrier-oss-v1-0.6b}"
export GA_EMB_DEFAULT_MODEL_ID="${GA_EMB_DEFAULT_MODEL_ID:-microsoft/harrier-oss-v1-0.6b}"
